<?php
/**
 * Title: Galerie 03 — mosaïque six images
 * Slug: maji/commun-galerie-03
...
$maji_img_d = esc_url( get_template_directory_uri() . '/assets/img/ph-square.svg' );
$maji_img_e = esc_url( get_template_directory_uri() . '/assets/img/ph-card.svg' );
$maji_img_f = esc_url( get_template_directory_uri() . '/assets/img/ph-portrait.svg' );
?>
...
<div class="wp-block-group alignfull has-surface-background-color has-background" style="padding-top:var(--wp--preset--spacing--60);padding-bottom:var(--wp--preset--spacing--60)">
	...
	<h2 class="wp-block-heading has-text-align-center has-2-xl-font-size">Notre univers</h2>
	<!-- /wp:heading -->
	<!-- wp:gallery {"columns":3,"linkTo":"none","align":"wide","style":{"spacing":{"margin":{"top":"var:preset|spacing|50"}}}} -->
	<figure class="wp-block-gallery alignwide has-nested-images columns-3 is-cropped" style="margin-top:var(--wp--preset--spacing--50)">
		...
		<!-- /wp:image -->
		<!-- wp:image {"sizeSlug":"large","linkDestination":"none","lightbox":{"enabled":true}} -->
		<figure class="wp-block-image size-large"><img src="<?php echo $maji_img_e; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- échappé ci-dessus. ?>" alt="" data-maji-media="gallery-5"/></figure>
		<!-- /wp:image -->
		<!-- wp:image {"sizeSlug":"large","linkDestination":"none","lightbox":{"enabled":true}} -->
		<figure class="wp-block-image size-large"><img src="<?php echo $maji_img_f; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- échappé ci-dessus. ?>" alt="" data-maji-media="gallery-6"/></figure>
		<!-- /wp:image -->
	</figure>
	<!-- /wp:gallery -->
</div>
