<?php
/**
 * Title: Chiffres 01 — repères du restaurant
 * Slug: maji/resto-chiffres-01
...
<div class="wp-block-group alignfull has-primary-contrast-color has-primary-background-color has-text-color has-background" style="padding-top:var(--wp--preset--spacing--60);padding-bottom:var(--wp--preset--spacing--60)">
	...
	<div class="wp-block-columns alignwide">
		...
		<div class="wp-block-column">
			<!-- wp:heading {"textAlign":"center","level":2,"textColor":"primary-contrast","fontSize":"3xl"} -->
			<h2 class="wp-block-heading has-text-align-center has-primary-contrast-color has-text-color has-3-xl-font-size">{{maji:content.facts.specialites}}</h2>
			<!-- /wp:heading -->
			<!-- wp:paragraph {"align":"center","fontSize":"sm"} -->
			<p class="has-text-align-center has-sm-font-size">Notre cuisine</p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:column -->
		<!-- wp:column -->
